    ...
    public partial class initBD : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pilote", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartPrevu = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ArriverPrevu = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AeroportDepartId = table.Column<int>(type: "int", nullable: false),
                    AeroportArriverId = table.Column<int>(type: "int", nullable: false),
                    HelicopterId = table.Column<int>(type: "int", nullable: false),
                    DepartFinal = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ArriverFinal = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RaisonRetard = table.Column<string>(type: "nvarchar(max)", nullable: false),
